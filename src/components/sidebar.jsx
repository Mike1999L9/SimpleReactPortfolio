        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(images/AboutMe.JPG)'}} />
              <h1 id="colorlib-logo"><a href="index.html">Jerry Ho</a></h1>
              <span className="email"><i className="icon-mail"></i> jerrysiuhin@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li><a href="https://www.linkedin.com/in/siuhinhojerry/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
            ...
            <div className="colorlib-footer">
              <p><small>
                ...
                There you go! An accounting student attempting to build website.
              </small></p>
            </div>
          </aside>
        </div>
